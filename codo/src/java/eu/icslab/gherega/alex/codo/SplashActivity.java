...
import eu.icslab.gherega.alex.codo.R;
...
public class SplashActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (firstLaunch) {
            firstLaunch = false;
            setupSplash();
            App.loadAsynchronously("eu.icslab.gherega.alex.codo.MainActivity",
                                   new Runnable() {
                                       @Override
                                       public void run() {
                                           proceed();
    ...
    public void proceed() {
        startActivity(new Intent("eu.icslab.gherega.alex.codo.MAIN"));
        finish();
    }
